...
const HeadTitle = ({
	...
	return (
		<div className='flex justify-between items-center pb-3'>
			...
			<div>
				<p className=' relative group font-medium text-sm text-orange-400  underline-offset-2 transition-transform duration-500 ease-in delay-200 decoration-orange-500 cursor-pointer'>
					<span>{link}</span>
