...
const FixturesCard = ({
	...
	return (
		<div
			// key={arr}
			className='bg-white rounded-md snap-center py-2 border-l-8 border-orange-500 w-[400px]  md:w-[300px] flex'>
			...
			<div className='border-l ml-4 px-2 flex flex-col items-end justify-centerx'>
				...
				<Button
					className='uppercase w-full md:w-[100px] rounded-full mt-5 text-black/60 !text-[10px] font-semibold'
					variant={"outline"}>
					view Fixtures
				</Button>
			</div>
